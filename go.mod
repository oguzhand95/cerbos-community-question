module github.com/oguzhand95/cerbos-community-questions

go 1.23

require github.com/cerbos/cerbos-sdk-go v0.2.10
...
require (
	...
	github.com/cerbos/cerbos/api/genpb v0.38.1 // indirect
